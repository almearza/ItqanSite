...
namespace Itqan.Controllers
{
    ...
    public class AccountController : MyController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal("~/Goals/blank");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = " تم اضافة الموظف بنجاح";

                    return RedirectToAction("blank", "Goals");
                }
                ViewBag.Roles = new SelectList(db.Roles.ToList(), "Name", "Name");
        ...
        [HttpPost]
        public ActionResult EditProfil(EditProfileViewModel Profile)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "تمت تحديث البيانات بنجاح";
            }
